...
document.querySelector('#whatsapp-form')?.addEventListener('submit', (event) => {
  ...
  const mensagem = [
    'Olá, Nova Era Estética Automotiva! Vim pelo site e gostaria de solicitar um atendimento.',
    '',
    `Nome: ${nome}`,
  ...
  window.open(`https://wa.me/5546999815898?text=${encodeURIComponent(mensagem)}`, '_blank', 'noopener');
});
